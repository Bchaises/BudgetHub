    ...
    <div class="flex flex-col items-center">
        ...
        <div class="w-2/3 flex justify-center">
                    ...
                    @foreach($categories as $category)
                        <tr class="hover:bg-gray-50 border-b">
                            ...
                            <td class="p-4 text-gray-700 flex items-center">
                                <form method="POST" action="{{ route('category.destroy', ['id' => $category->id]) }}" class="m-0">
                                    @method('delete')
                                    @csrf
                                ...
                                <a href="{{ route('category.show', ['id' => $category->id]) }}" class="ml-3">
            ...
            <div class="m-8 w-full basis-1/3">
                <form method="POST" action="{{ route('category.store') }}" class="flex flex-col ">
                    @csrf <!-- {{ csrf_field() }} -->
                    <div class="mt-2">
