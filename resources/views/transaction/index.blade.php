<x-app-layout>
    ...
    <div class="flex justify-center">
        <div class="overflow-x-auto rounded-lg shadow-lg my-8 mr-8 w-full basis-2/3">
        ...
        <div class="my-8 ml-8 w-full basis-1/3">
    ...
    <div class="w-2/3">
        <a href="{{ route('category.index') }}" class="bg-indigo-500 hover:bg-indigo-600 text-white p-2 px-4 rounded-lg">
